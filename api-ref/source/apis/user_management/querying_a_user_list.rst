...
-  Example request
   ...
   .. code-block::
      ...
      curl -i -k -H 'Accept:application/json' -H "X-Auth-Token:$token" -X GET https://sample.domain.com/v3/users
...
-  Parameters in the response body
   ...
   | Parameter                                                                | Mandatory | Type        | Description               |
   +==========================================================================+===========+=============+===========================+
   | :ref:`users <en-us_topic_0057845638__l86920d09d4224a93a4379c10a51077f0>` | Yes       | JSONArray   | User list.                |
   +--------------------------------------------------------------------------+-----------+-------------+---------------------------+
   | :ref:`links <en-us_topic_0057845638__li1850919515437>`                   | Yes       | JSON object | Links of a user resource. |
   +--------------------------------------------------------------------------+-----------+-------------+---------------------------+

-  .. _en-us_topic_0057845638__l86920d09d4224a93a4379c10a51077f0:
   ...
   +-------------------------------------------------------+-----------+-------------+-------------------------------------------------------------------------------------------------------------------------+
   | :ref:`links <en-us_topic_0057845638__li130384424415>` | Yes       | JSON object | User resource link.                                                                                                     |
   +-------------------------------------------------------+-----------+-------------+-------------------------------------------------------------------------------------------------------------------------+
...
-  .. _en-us_topic_0057845638__li1850919515437:
...
-  .. _en-us_topic_0057845638__li130384424415:
