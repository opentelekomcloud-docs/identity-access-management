...
.. table:: **Table 3** user
   ...
   +-----------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | pwd_status      | No              | Boolean         | **Definition**                                                                                                                                                                                                                                                                                                |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | Whether password reset is required at the first login. This parameter is valid only when **password** is not empty.                                                                                                                                                                                           |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | **Constraints**                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | N/A                                                                                                                                                                                                                                                                                                           |
   ...
   |                 |                 |                 | **Range**                                                                                                                                                                                                                                                                                                     |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | -  **true**: The IAM user needs to reset password upon first login.                                                                                                                                                                                                                                           |
   |                 |                 |                 | -  **false**: The IAM user does not need to reset password upon first login.                                                                                                                                                                                                                                  |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | **Default Value**                                                                                                                                                                                                                                                                                             |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | If **password** is empty, this parameter defaults to **false**.                                                                                                                                                                                                                                               |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                               |
   |                 |                 |                 | If **password** is not empty, this parameter defaults to **true**.                                                                                                                                                                                                                                            |
   +-----------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 5** user
   ...
   +-----------------------+-----------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | pwd_status            | Boolean               | **Definition**                                                                                                                                                                                                                                                                                               |
   |                       |                       |                                                                                                                                                                                                                                                                                                              |
   |                       |                       | Whether password reset is required at the first login.                                                                                                                                                                                                                                                       |
   |                       |                       |                                                                                                                                                                                                                                                                                                              |
   |                       |                       | **Constraints**                                                                                                                                                                                                                                                                                              |
   |                       |                       |                                                                                                                                                                                                                                                                                                              |
   |                       |                       | N/A                                                                                                                                                                                                                                                                                                          |
