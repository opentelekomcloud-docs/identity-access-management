:original_name: iam_02_0030.html
...
.. table:: **Table 4** api_acl_policy
   ...
   +----------------------------------------------------------------+------------------+-----------------------------------------------------+
   | :ref:`allow_vpc_endpoints <iam_02_0030__table1566243511197>`   | Array of objects | VPC endpoints from which API access is allowed.     |
   +----------------------------------------------------------------+------------------+-----------------------------------------------------+
...
.. _iam_02_0030__table1566243511197:
...
.. table:: **Table 7** allow_vpc_endpoints
   ...
   | Parameter       | Type   | Description                                                         |
   +=================+========+=====================================================================+
   | vpc_endpoint_id | String | VPC endpoint ID, for example, **8di3jdu38d7jhfa7df68adyfiadfia6d**. |
   +-----------------+--------+---------------------------------------------------------------------+
   | description     | String | Description about the VPC endpoint.                                 |
   +-----------------+--------+---------------------------------------------------------------------+
