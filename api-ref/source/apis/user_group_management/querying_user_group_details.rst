...
-  Example request
   ...
   .. code-block::
      ...
      curl -i -k -H "X-Auth-Token:$token" -X GET https://sample.domain.com/v3/groups/ab9f261180d746ef8624beb5ae39b5aa
...
-  Parameters in the response body
   ...
   +=========================================================+=============+================================+
   | :ref:`group <en-us_topic_0057845618__li10660645112415>` | JSON object | Response body of a user group. |
   +---------------------------------------------------------+-------------+--------------------------------+

-  .. _en-us_topic_0057845618__li10660645112415:
   ...
   +--------------------------------------------------------+------------+-------------------------------------------------+
   | domain_id                                              | String     | ID of the domain to which a user group belongs. |
   +--------------------------------------------------------+------------+-------------------------------------------------+
   | id                                                     | String     | User group ID.                                  |
   +--------------------------------------------------------+------------+-------------------------------------------------+
   | :ref:`links <en-us_topic_0057845618__li7986733142515>` | JSONObject | Links to a user group.                          |
   +--------------------------------------------------------+------------+-------------------------------------------------+
...
-  .. _en-us_topic_0057845618__li7986733142515:
