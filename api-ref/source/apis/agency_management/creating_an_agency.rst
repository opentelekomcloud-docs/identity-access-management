...
-  Parameters in the request body
   ...
   | Parameter                                               | Mandatory | Type   | Description         |
   +=========================================================+===========+========+=====================+
   | :ref:`agency <en-us_topic_0079467617__li1537812520422>` | Yes       | Object | Agency information. |
   +---------------------------------------------------------+-----------+--------+---------------------+

-  .. _en-us_topic_0079467617__li1537812520422:
   ...
   +-------------------+-----------+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | trust_domain_id   | No        | String | ID of the delegated domain. Either **trust_domain_id** or **trust_domain_name** must be specified. If both of them are specified, **trust_domain_name** takes precedence.                                                                                        |
   +-------------------+-----------+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | trust_domain_name | No        | String | Name of the delegated domain. Either **trust_domain_id** or **trust_domain_name** must be specified. If both of them are specified, **trust_domain_name** takes precedence.                                                                                      |
   +-------------------+-----------+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | description       | No        | String | Description of an agency, which can contain up to 255 characters.                                                                                                                                                                                                |
   +-------------------+-----------+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   .. note::
      ...
      At least one of **trust_domain_id** and **trust_domain_name** is specified in the request body. If both are specified, **trust_domain_name** will be used.
...
-  Parameters in the response body
   ...
   | Parameter                                              | Mandatory | Type        | Description       |
   +========================================================+===========+=============+===================+
   | :ref:`agency <en-us_topic_0079467617__li195373151589>` | Yes       | JSON object | Delegated object. |
   +--------------------------------------------------------+-----------+-------------+-------------------+

-  .. _en-us_topic_0079467617__li195373151589:
