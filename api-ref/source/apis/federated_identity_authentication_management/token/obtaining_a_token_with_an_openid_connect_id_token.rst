...
.. table:: **Table 5** auth.scope
   ...
   +----------------------------------------------------+-----------+--------+-------------------------------------------------------+
   | :ref:`project <iam_13_0605__table192421733175115>` | No        | object | Project scope details. Specify a project or a domain. |
   +----------------------------------------------------+-----------+--------+-------------------------------------------------------+

.. _iam_13_0605__table1379356134320:

.. table:: **Table 6** auth.scope.domain
...
.. _iam_13_0605__table192421733175115:

.. table:: **Table 7** auth.scope.project
...
.. table:: **Table 8** Parameters in the response header
...
.. table:: **Table 10** token
   ...
   +---------------------------------------------------+------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`domain <iam_13_0605__table1544021518267>`   | object           | Domain details.                                                                                         |
   +---------------------------------------------------+------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`project <iam_13_0605__table18407115614438>` | object           | Project details.                                                                                        |
   +---------------------------------------------------+------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`roles <iam_13_0605__table3459143617>`       | Array            | Policy details.                                                                                         |
   +---------------------------------------------------+------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`catalog <iam_13_0605__table14410115674311>` | Array            | Catalog details.                                                                                        |
   +---------------------------------------------------+------------------+---------------------------------------------------------------------------------------------------------+

.. _iam_13_0605__table63957566436:

.. table:: **Table 11** token.user
...
.. table:: **Table 12** token.user.OS-FEDERATION

   +------------------------------------------------------------+--------+----------------------------+
   | Parameter                                                  | Type   | Description                |
   +============================================================+========+============================+
   | :ref:`identity_provider <iam_13_0605__table1401155654314>` | object | Identity provider details. |
   +------------------------------------------------------------+--------+----------------------------+
   | :ref:`protocol <iam_13_0605__table1440310561432>`          | object | Protocol details.          |
   +------------------------------------------------------------+--------+----------------------------+
   | :ref:`groups <iam_13_0605__table2094345342719>`            | Array  | User group details.        |
   +------------------------------------------------------------+--------+----------------------------+

.. _iam_13_0605__table1401155654314:

.. table:: **Table 13** token.user.OS-FEDERATION.identity_provider
...
.. table:: **Table 14** token.user.OS-FEDERATION.protocol
...
.. _iam_13_0605__table2094345342719:

.. table:: **Table 15** token.user.OS-FEDERATION.groups
...
.. table:: **Table 16** token.user.domain
...
.. _iam_13_0605__table1544021518267:

.. table:: **Table 17** token.domain
...
.. table:: **Table 18** token.project

   ================================================ ====== ===============
   Parameter                                        Type   Description
   ================================================ ====== ===============
   :ref:`domain <iam_13_0605__table17862185014158>` object Domain details.
...
.. _iam_13_0605__table17862185014158:

.. table:: **Table 20** token.project.domain
...
.. _iam_13_0605__table3459143617:

.. table:: **Table 21** token.roles
