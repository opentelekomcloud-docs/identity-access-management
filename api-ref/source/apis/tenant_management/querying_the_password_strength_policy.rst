...
-  Example request
   ...
   .. code-block::
      ...
      curl -i -k -H 'Accept:application/json' -H "X-Auth-Token:$token" -X GET https://sample.domain.com/v3/domains/{domain_id}/config/security_compliance
...
-  Parameters in the response body
   ...
   +============================================+========+============================+
   | :ref:`config <iam_02_0007__li69261810720>` | Object | Configuration information. |
   +--------------------------------------------+--------+----------------------------+

-  .. _iam_02_0007__li69261810720:
   ...
   | Parameter                                               | Type   | Description                           |
   +=========================================================+========+=======================================+
   | :ref:`security_compliance <iam_02_0007__li46312111676>` | Object | Password strength policy information. |
   +---------------------------------------------------------+--------+---------------------------------------+

-  .. _iam_02_0007__li46312111676:
