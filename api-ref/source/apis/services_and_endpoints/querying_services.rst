...
-  Parameters in the response body
   ...
   | Parameter                                                  | Mandatory | Type             | Description            |
   +============================================================+===========+==================+========================+
   | :ref:`links <en-us_topic_0057845587__li19598601056>`       | Yes       | Object           | Service resource link. |
   +------------------------------------------------------------+-----------+------------------+------------------------+
   | :ref:`services <en-us_topic_0057845587__li18942012183711>` | Yes       | Array of objects | A list of services.    |
   +------------------------------------------------------------+-----------+------------------+------------------------+

-  .. _en-us_topic_0057845587__li18942012183711:
   ...
   +--------------------------------------------------------+---------+---------------------------------+
   | :ref:`links <en-us_topic_0057845587__li1529034332013>` | Object  | Service resource link.          |
   +--------------------------------------------------------+---------+---------------------------------+

-  .. _en-us_topic_0057845587__li1529034332013:
...
-  .. _en-us_topic_0057845587__li19598601056:
