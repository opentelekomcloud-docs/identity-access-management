...
-  Parameters in the response body
   ...
   | Parameter                                                  | Mandatory | Type | Description             |
   +============================================================+===========+======+=========================+
   | :ref:`links <en-us_topic_0057845562__li299942695817>`      | Yes       | dict | Endpoint resource link. |
   +------------------------------------------------------------+-----------+------+-------------------------+
   | :ref:`endpoints <en-us_topic_0057845562__li1017165620378>` | Yes       | list | List of endpoints.      |
   +------------------------------------------------------------+-----------+------+-------------------------+

-  .. _en-us_topic_0057845562__li1017165620378:
   ...
   +---------------------------------------------------------+-----------+---------+-------------------------------------------------+
   | :ref:`links <en-us_topic_0057845562__li19803625155818>` | Yes       | dict    | Endpoint resource link.                         |
   +---------------------------------------------------------+-----------+---------+-------------------------------------------------+

-  .. _en-us_topic_0057845562__li299942695817:
...
-  .. _en-us_topic_0057845562__li19803625155818:
